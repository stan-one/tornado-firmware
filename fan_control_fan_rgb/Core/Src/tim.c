...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = LED_STRIP_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
    HAL_GPIO_Init(LED_STRIP_1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = RGB_FAN_1_Pin|RGB_FAN_3_Pin|RGB_FAN_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = RGB_FAN_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM2;
    HAL_GPIO_Init(RGB_FAN_2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = PWM_FAN_1_Pin|PWM_FAN_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = PWM_FAN_3_Pin|PWM_FAN_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM3;
